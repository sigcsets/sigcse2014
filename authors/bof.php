...
<div class="row-fluid">
 <div class="span12">
<p>BOF proposals are to be provided in PDF format. The full proposal contains an up to <?php echo $abstractWordLimit; ?> BOF abstract. The abstract needs to appear in two places: in the PDF proposal and in a text box on the submission page (see below). The format for the BOF proposal is as follows.</p>
...
<ol>
 ...
 <li><strong>BOF Abstract (limited to <?php echo $abstractWordLimit; ?>)</strong>
  <p style="font-size: 1.0em">The abstract is the description of the BOF that will appear on the conference web pages.  The description is limited to <?php echo $abstractWordLimit; ?> and must match verbatim the abstract section of the BOF Proposal. The BOF abstract must be submitted in plain text. The abstract for an accepted proposal may contain a URL with more information.  (Abstracts of accepted BOFs can be edited in response to reviews.)</p>
 </li>
</ol>
...
?>. Recall that you will also need to cut-and-paste or type your <?php echo $abstractWordLimit; ?> text abstract description into a text box during the submission process.  Please do not wait until the last minute to submit your documents because that is when everyone else will be connecting to our server!</li>
